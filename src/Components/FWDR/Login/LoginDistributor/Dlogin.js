...
import Bg from '../../../../Images/img/distributer.jpg';
...
export default function Wlogin() {
  ...
  const handleSubmit=(e)=>{
    ...
    Axios({
      method: 'post',
      url:`${REACT_APP_URL}/DistributorLogin`,
      data:data
    }).then(res=>{
  ...
  return (
    ...
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={false} sm={4} md={7} className={classes.image}>
          <div>
              <h1 style={{textAlign:"center",fontWeight:"900"}}>DISTRIBUTOR</h1>
          </div>
      </Grid>
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <div className={classes.paper}>
          ...
          <form className={classes.form} onSubmit={handleSubmit} validate={true}>
            ...
            <Grid container>
              <Grid item>
               <Link to="/createDistributorAccount" >
