...
export default function SignUp() {
  ...
  return(
    <React.Fragment>
      ...
      <Typography><span style={{color:"red"}}>Note:</span>You can verify the product by scaning QR code of product. It is conforming that the product is verified from Retailer Center.</Typography>
