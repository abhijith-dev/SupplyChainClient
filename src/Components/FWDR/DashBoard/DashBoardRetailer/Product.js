...
export default function SignUp() {
  ...
  return(
    <React.Fragment>
      ...
      <Typography><span style={{color:"red"}}>Note:</span>You can verify the product by entering product id. It is conforming that the product is verified from Retailer Center.</Typography>
