...
export default function Map({id,setShift}) {
    ...
    React.useEffect(()=>{
        if(loc1==='' || loc2==='' || loc3==='' || loc4===''){
            ...
            fetch(`http://api.positionstack.com/v1/forward?access_key=e1004c97cae384b5ac773306c2cc8149&query=${loc1}`)
            .then(res=>res.json())
            .then(data=>{setLat1(parseFloat(data.data[0].longitude));setLng1(parseFloat(data.data[0].longitude))})
            .catch(e=>{setError(true)})
            fetch(`http://api.positionstack.com/v1/forward?access_key=e1004c97cae384b5ac773306c2cc8149&query=${loc2}`)
            .then(res=>res.json())
            .then(data=>{setLat2(parseFloat(data.data[0].latitude));setLng2(parseFloat(data.data[0].longitude))})
            .catch(e=>{setError(true)})
            fetch(`http://api.positionstack.com/v1/forward?access_key=e1004c97cae384b5ac773306c2cc8149&query=${loc3}`)
            .then(res=>res.json())
            .then(data=>{setLat3(parseFloat(data.data[0].latitude));setLng3(parseFloat(data.data[0].longitude))})
            .catch(e=>{setError(true)})
            fetch(`http://api.positionstack.com/v1/forward?access_key=e1004c97cae384b5ac773306c2cc8149&query=${loc4}`)
            .then(res=>res.json())
            .then(data=>{setLat4(parseFloat(data.data[0].latitude));setLng4(parseFloat(data.data[0].longitude))})
            .catch(e=>{setError(true)})  
        }
    },[loc1,loc2,loc3,loc4])
